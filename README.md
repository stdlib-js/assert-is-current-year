...
```javascript
import isCurrentYear from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-current-year@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-current-year/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/assert-is-current-year/actions/workflows/test.yml?query=branch:v0.1.0
